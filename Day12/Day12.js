...
const menuTag = document.querySelector('section');

const dinnerFoodsDivs = dinnerFoods.map(el => `<div class="food">${el}</div>`);
menuTag.innerHTML = ""
dinnerFoodsDivs.forEach(el => menuTag.innerHTML += el);