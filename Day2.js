...
// The purpose of the below solution was to practice using reduce, however considering the input/output data here, using .map is a preferable solution. 

function transformData(data){
  return data.reduce((acc, curr) => {
      const dateObj = new Date(curr.dob.date);
      acc.push({
          fullName: curr.name.first + " " + curr.name.last,
